...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.language'
        db.alter_column(u'chatterbox_message', 'language', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'Message.language'
        db.alter_column(u'chatterbox_message', 'language', self.gf('django.db.models.fields.TextField')())
