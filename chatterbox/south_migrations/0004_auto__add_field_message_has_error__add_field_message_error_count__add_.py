...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.has_error'
        db.add_column(u'chatterbox_message', 'has_error',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.error_count'
        db.add_column(u'chatterbox_message', 'error_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Message.error_data'
        db.add_column(u'chatterbox_message', 'error_data',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Message.has_failed'
        db.add_column(u'chatterbox_message', 'has_failed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.has_error'
        db.delete_column(u'chatterbox_message', 'has_error')

        # Deleting field 'Message.error_count'
        db.delete_column(u'chatterbox_message', 'error_count')

        # Deleting field 'Message.error_data'
        db.delete_column(u'chatterbox_message', 'error_data')

        # Deleting field 'Message.has_failed'
        db.delete_column(u'chatterbox_message', 'has_failed')
